...
public class TimestampConsts {
	...
	public static final Set<String> DEFAULT_TIMESTAMP_PATTERNS = 
		new LinkedHashSet<>(Arrays.asList(new String[] { 
		
		"yyyy-MM-dd'T'HH:mm:ss*SSSZZZZ", // 2018-08-20'T'13:20:10*633+0000
		"yyyy MMM dd HH:mm:ss.SSS zzzZ", // 2017 Mar 03 05:12:41.211 PDT				
		"yyyy MMM dd HH:mm:ss.SSS zzzZ", // 2017 Mar 03 05:12:41.211 PDT
		...
		"yyyy-MM-dd HH:mm:ss.S", // 2017-12-10 01:44:20.3						
	...
	public static Set<String> DEFAULT_TIMESTAMP_CONSTS = 
		new HashSet<>(Arrays.asList(new String[] {"\"'T'\""}));
